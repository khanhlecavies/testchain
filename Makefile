...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=testchain \
		-X github.com/cosmos/cosmos-sdk/version.AppName=testchaind \
...
install: go.sum
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/testchaind

build:
	go build $(BUILD_FLAGS) -o bin/testchaind ./cmd/testchaind
