...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".testchain")
}
...
func NewSimApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		minttypes.StoreKey, distrtypes.StoreKey, slashingtypes.StoreKey, capabilitytypes.StoreKey,
	...
	*/
	...
	genesisModuleOrder := []string{
		...
		minttypes.ModuleName, crisistypes.ModuleName, genutiltypes.ModuleName, paramstypes.ModuleName, upgradetypes.ModuleName,
